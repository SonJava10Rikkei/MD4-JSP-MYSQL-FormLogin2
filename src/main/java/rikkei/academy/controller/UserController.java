...
public class UserController extends HttpServlet {
    ...
    private void actionLogin(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (user != null) {
            ...
            request.setAttribute("validate", "Loi dang nhap, Hay xem lai");
            showFormLogin(request, response);
        }
    }
    ...
    private void logOut(HttpServletRequest request, HttpServletResponse response) {
        HttpSession session = request.getSession(false); // check session cos ton tai khong? neu ton taij tra ve obj tuong ung con thi khong thi null
